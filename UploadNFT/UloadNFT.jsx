    ...
    <div className={Style.upload}>
      ...
      <div className={Style.upload_box}>
        <div className={formStyle.Form_box_input}>
          ...
          <input
            type="text"
            placeholder="Your Asset name or Collection"
        ...
        <div className={formStyle.Form_box_input}>
          ...
          <div className={formStyle.Form_box_input_box}>
            ...
            <input
              type="text"
              placeholder="www.mywebsitename.com"
        ...
        <div className={formStyle.Form_box_input}>
          ...
          <textarea
            ...
            cols="30"
            rows="6"
            placeholder="Tell Us something about your Asset in few words"
